...
public:
	...
	static SimpleDPad *dPadWithFile(const char *rockerImageName, const char *rockerBGImageName, cocos2d::Point position);
	virtual bool rockerInit(const char *rockerImageName, const char *rockerBGImageName, cocos2d::Point position);
...
protected:
	...
	cocos2d::Point				    m_sDirection;			    // 当前所按下的方向。这是一个矢量，(-1.0, -1.0)是左下方向，(1.0, 1.0)是右上方向。
	bool							m_bIsCanMove;				// 是否可操作摇杆
	cocos2d::Point				    m_sRockerBGPosition;		// 摇杆背景的坐标
